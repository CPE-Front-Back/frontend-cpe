    ...
    <>
      ...
      <Container>
        <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
          ...
          <Button variant="contained" style={{ textTransform: 'none' }} startIcon={<Iconify icon="eva:plus-fill" />}>
            Registrar Capacidad
          </Button>
        </Stack>
                    ...
                    return (
                      <TableRow hover key={cod_capacidad} tabIndex={-1} role="checkbox" selected={selectedCapacity}>
                        <TableCell padding="checkbox">
                          <Checkbox
                            checked={selectedCapacity}
                            onChange={(event) => handleClick(event, cod_capacidad)}
                          />
                        </TableCell>
