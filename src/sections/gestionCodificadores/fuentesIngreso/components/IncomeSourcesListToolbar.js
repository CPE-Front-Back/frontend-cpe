...
IncomeSourcesListToolbar.propTypes = {
  numSelected: PropTypes.number,
  filterValue: PropTypes.string,
  onFilterValue: PropTypes.func,
  handleDelete: PropTypes.func,
};
export default function IncomeSourcesListToolbar({ numSelected, filterValue, onFilterValue, handleDelete }) {
  return (
    <StyledRoot
      sx={{
        ...(numSelected > 0 && {
    ...
    >
      {numSelected > 0 ? (
        ...
        <StyledSearch
          ...
          placeholder="Buscar fuente de ingreso..."
          startAdornment={
